...
urlpatterns = [
    ...
    path('video_post_list/', video_post_list, name = 'video_post_list'), # 영상 - 특정 게시물 가져 오기
    path('video_post_create/', video_post_create, name = 'video_post_create'),# 영상 - 특정 게시물 작성하기
    path('<int:post_pk>/video_post_update_delete/', video_post_update_delete, name = 'video_post_update_delete'), # 영상 - 특정 게시물 수정 / 삭제
